...
ggsave('growth-models.png', width = 6, height = 3)
```
...
ggsave('spatial-domain.png', height = 4, width = 4)
```
...
ggsave('functions.png', width = 5, height = 6)
```
...
ggsave('beta1.png', height = 4, width = 6)
```
...
ggsave('beta2.png', height = 4, width = 6)
```
...
ggsave('beta2alpha1.png', width = 7.5, height = 5)
```
...
ggsave('beta2alpha2.png', width = 7.5, height = 7.5)
```
